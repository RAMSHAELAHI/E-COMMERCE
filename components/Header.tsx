...
import { useCart } from '@/src/app/context/CartContext'; // If you want to show cart count
import { useWishlist } from '@/src/app/context/WishlistContext'; // For wishlist count
